...
C:/VulkanSDK/1.3.236.0/Bin/glslc.exe composite.comp -o composite_comp.spv
C:/VulkanSDK/1.3.236.0/Bin/glslc.exe composite_depthoffset.comp -o composite_depthoffset_comp.spv
